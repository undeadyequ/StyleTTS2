...
if __name__ == '__main__':
    ...
    ilens = torch.tensor([216]).unsqueeze(0)
    olens = torch.tensor([216]).unsqueeze(0)
    ...
    #save_plot(guide_matrix[0].detach().cpu(), f'/home/rosen/Project/DrawSpeech_PyTorch/exp/res/monoMask_test1.png')
    ...
    for sigma in [0.1, 0.2, 0.5, 0.8]:
        for max_len in [50, 100, 200]:
            ...
            print(guide_matrix2)
            save_plot(guide_matrix2[0].detach().cpu(), f'/home/rosen/Project/DrawSpeech_PyTorch/exp/res/monoMask_{max_len}_reflen200_{sigma}.png')