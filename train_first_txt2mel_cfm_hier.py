...
@click.command()
@click.option('-p', '--config_path', default='Configs/config_libritts_txt2mel_cfm_v17.yml', type=str)
    ...
    for epoch in range(start_epoch, epochs):
        ...
        for i, batch in enumerate(train_dataloader):
            ...
            if cond_prosody_type == "hierstyle":
                ...
                _, _, N_real_phone, F0_real_phone = frame_to_phoneme_avg_and_back_binary(real_norm, F0_real, s2s)
            ...
            loss_cfm, attn_maps  = model.decoder.compute_loss(gt, ~mel_cut_mask.unsqueeze(1), mu=en, c=s, seq_style=pe,
                                                              p_mask=~mel_cut_mask.unsqueeze(1), seq_style_gt=pe_real)
        ...
        with torch.no_grad():
            ...
            for batch_idx, batch in enumerate(val_dataloader):
                ...
                loss_cfm, attn_maps = model.decoder.compute_loss(gt, mask, mu=en, c=s, seq_style=pe, p_mask=mask, seq_style_gt=pe_real)
