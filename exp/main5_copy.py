...
from inference_benchmark_models import inference_monoDiT, inference_hierspeech, inference_Dit, inference_drawspeech, inference_styletts2
    ...
    if start_step <= 0 <= end_step:
        for i, model_name in enumerate(cmp_modelnames):
            ...
            if "drawspeech" in model_name:
                pass
                #infer_drawspeech_cmd = f"/home/rosen/miniconda3/envs/ddpm/bin/python /home/rosen/Project/DrawSpeech_PyTorch/exp/main4.py "
                #os.system(infer_drawspeech_cmd)
            elif "monoDiT" in model_name:
                print("synthesized by monoDiT model")
                attn_dict = inference_monoDiT(ckpt, model_configs, synTexts, syn_styles, out_speech_dir,
                                              model_infer_config[model_name], save_attn=save_attn)
                ...
                raise IOError(f"{model_name} not supported!!")
    else:
...
if __name__ == "__main__":
    ...
    ######### 3. INPUT
    parser.add_argument("--style", type=str, default="exp/data/r1_50.txt")  # evalstyle  r1_test  r1 libri_r1, r1_v2, r1_50
    parser.add_argument("--txt", type=str, default="exp/data/s1_5.txt")  # evaltxt_para.txt libri_s1, s1_v2, s1_5
    ...
    eval_models = ["monoDiT", "DiT", "drawspeech", "styletts2", "hierspeech", "monoDiT_ab0808_m08_fbnone"]  # "monoDiT", "DiT", "drawspeech", "styletts2", "hierspeech"
    ...
    if EVAL_FINE1:
        ...
        ## INPUT
        style_syn_f_dir = "/home/rosen/Project/StyleTTS2/exp/data2"
        ...
        ## OUTPUT
        out_dir = f"/home/rosen/ckpt/exp/mdit_tts_{dataset_name}_fine1"  #
    ...
    if EVAL_FINE2:
        ...
        ## OUTPUT
        out_dir = f"/home/rosen/ckpt/exp/mdit_tts_{dataset_name}_fine2"  #
        ...
        for fine_cate_label, fine_synText in zip(fine_categ_labels, fine_synTexts):
            main(
                ...
                out_dir=out_dir,
                start_step=0,
                end_step=0,  # DO first 0,0, and second 1, 2
                mel_config=mel_config,
                vis_attn_config=vis_attn_config[dataset_name],
                vis_psd_config=vis_psd_config[dataset_name],
                vis_psdmel_config=vis_psdmel_config[dataset_name],
