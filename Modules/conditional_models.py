...
from Modules.text_encoder.encoder import TextEncoder
from Modules.fastspeech2.modules import VarianceAdaptor
from Modules.contour_predictor.model import Sketch2ContourPredictor

from utilities.tools import wav_mask_to_latent_mask, modify_curve_length, min_max_normalize, wav_mask_to_latent_mask, sketch_extractor, make_decision
from utilities.diffusion_util import conv_nd
...
class TextEncoderwithVarianceAdaptor(nn.Module):
    ...
    def forward(self, inputs):
        ...
        output, p_predictions, e_predictions, log_d_predictions, d_rounded, mel_lens, _mel_mask = self.variance_adaptor(
            text_emb, _src_mask, _mel_mask, max_mel_len, pitch, energy, phoneme_duration)
